...
def test_get_lights_from_discovery_xml(rako_xml):
    ...
    expected_lights = [
        Light(room_id='5', room_title='Living Room', channel_id='1', channel_type='Default', channel_name='Downlights',
              channel_levels='FF347F3F000000000000000000000000'),
        Light(room_id='5', room_title='Living Room', channel_id='2', channel_type='Default',
              channel_name='Kitchen Downlights', channel_levels='FF337F3F000000000000000000000000'),
        Light(room_id='9', room_title='Bedroom 1', channel_id='1', channel_type='Default', channel_name='Downlights',
              channel_levels='FFBF7F25000000000000000000000000'),
        Light(room_id='9', room_title='Bedroom 1', channel_id='2', channel_type='Default', channel_name='LED',
